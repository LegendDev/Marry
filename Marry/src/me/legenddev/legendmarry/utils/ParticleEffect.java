...
{
    EXPLOSION_NORMAL("EXPLOSION_NORMAL", 0, "EXPLOSION_NORMAL", 0, "explode", 0, -1, new ParticleProperty[] { ParticleProperty.DIRECTIONAL }), 
    EXPLOSION_LARGE("EXPLOSION_LARGE", 1, "EXPLOSION_LARGE", 1, "largeexplode", 1, -1, new ParticleProperty[0]), 
    EXPLOSION_HUGE("EXPLOSION_HUGE", 2, "EXPLOSION_HUGE", 2, "hugeexplosion", 2, -1, new ParticleProperty[0]), 
    FIREWORKS_SPARK("FIREWORKS_SPARK", 3, "FIREWORKS_SPARK", 3, "fireworksSpark", 3, -1, new ParticleProperty[] { ParticleProperty.DIRECTIONAL }), 
    WATER_BUBBLE("WATER_BUBBLE", 4, "WATER_BUBBLE", 4, "bubble", 4, -1, new ParticleProperty[] { ParticleProperty.DIRECTIONAL, ParticleProperty.REQUIRES_WATER }), 
    WATER_SPLASH("WATER_SPLASH", 5, "WATER_SPLASH", 5, "splash", 5, -1, new ParticleProperty[] { ParticleProperty.DIRECTIONAL }), 
    WATER_WAKE("WATER_WAKE", 6, "WATER_WAKE", 6, "wake", 6, 7, new ParticleProperty[] { ParticleProperty.DIRECTIONAL }), 
    SUSPENDED("SUSPENDED", 7, "SUSPENDED", 7, "suspended", 7, -1, new ParticleProperty[] { ParticleProperty.REQUIRES_WATER }), 
    SUSPENDED_DEPTH("SUSPENDED_DEPTH", 8, "SUSPENDED_DEPTH", 8, "depthSuspend", 8, -1, new ParticleProperty[] { ParticleProperty.DIRECTIONAL }), 
    CRIT("CRIT", 9, "CRIT", 9, "crit", 9, -1, new ParticleProperty[] { ParticleProperty.DIRECTIONAL }), 
    CRIT_MAGIC("CRIT_MAGIC", 10, "CRIT_MAGIC", 10, "magicCrit", 10, -1, new ParticleProperty[] { ParticleProperty.DIRECTIONAL }), 
    SMOKE_NORMAL("SMOKE_NORMAL", 11, "SMOKE_NORMAL", 11, "smoke", 11, -1, new ParticleProperty[] { ParticleProperty.DIRECTIONAL }), 
    SMOKE_LARGE("SMOKE_LARGE", 12, "SMOKE_LARGE", 12, "largesmoke", 12, -1, new ParticleProperty[] { ParticleProperty.DIRECTIONAL }), 
    SPELL("SPELL", 13, "SPELL", 13, "spell", 13, -1, new ParticleProperty[0]), 
    SPELL_INSTANT("SPELL_INSTANT", 14, "SPELL_INSTANT", 14, "instantSpell", 14, -1, new ParticleProperty[0]), 
    SPELL_MOB("SPELL_MOB", 15, "SPELL_MOB", 15, "mobSpell", 15, -1, new ParticleProperty[] { ParticleProperty.COLORABLE }), 
    SPELL_MOB_AMBIENT("SPELL_MOB_AMBIENT", 16, "SPELL_MOB_AMBIENT", 16, "mobSpellAmbient", 16, -1, new ParticleProperty[] { ParticleProperty.COLORABLE }), 
    SPELL_WITCH("SPELL_WITCH", 17, "SPELL_WITCH", 17, "witchMagic", 17, -1, new ParticleProperty[0]), 
    DRIP_WATER("DRIP_WATER", 18, "DRIP_WATER", 18, "dripWater", 18, -1, new ParticleProperty[0]), 
    DRIP_LAVA("DRIP_LAVA", 19, "DRIP_LAVA", 19, "dripLava", 19, -1, new ParticleProperty[0]), 
    VILLAGER_ANGRY("VILLAGER_ANGRY", 20, "VILLAGER_ANGRY", 20, "angryVillager", 20, -1, new ParticleProperty[0]), 
    VILLAGER_HAPPY("VILLAGER_HAPPY", 21, "VILLAGER_HAPPY", 21, "happyVillager", 21, -1, new ParticleProperty[] { ParticleProperty.DIRECTIONAL }), 
    TOWN_AURA("TOWN_AURA", 22, "TOWN_AURA", 22, "townaura", 22, -1, new ParticleProperty[] { ParticleProperty.DIRECTIONAL }), 
    NOTE("NOTE", 23, "NOTE", 23, "note", 23, -1, new ParticleProperty[] { ParticleProperty.COLORABLE }), 
    PORTAL("PORTAL", 24, "PORTAL", 24, "portal", 24, -1, new ParticleProperty[] { ParticleProperty.DIRECTIONAL }), 
    ENCHANTMENT_TABLE("ENCHANTMENT_TABLE", 25, "ENCHANTMENT_TABLE", 25, "enchantmenttable", 25, -1, new ParticleProperty[] { ParticleProperty.DIRECTIONAL }), 
    FLAME("FLAME", 26, "FLAME", 26, "flame", 26, -1, new ParticleProperty[] { ParticleProperty.DIRECTIONAL }), 
    LAVA("LAVA", 27, "LAVA", 27, "lava", 27, -1, new ParticleProperty[0]), 
    FOOTSTEP("FOOTSTEP", 28, "FOOTSTEP", 28, "footstep", 28, -1, new ParticleProperty[0]), 
    CLOUD("CLOUD", 29, "CLOUD", 29, "cloud", 29, -1, new ParticleProperty[] { ParticleProperty.DIRECTIONAL }), 
    REDSTONE("REDSTONE", 30, "REDSTONE", 30, "reddust", 30, -1, new ParticleProperty[] { ParticleProperty.COLORABLE }), 
    SNOWBALL("SNOWBALL", 31, "SNOWBALL", 31, "snowballpoof", 31, -1, new ParticleProperty[0]), 
    SNOW_SHOVEL("SNOW_SHOVEL", 32, "SNOW_SHOVEL", 32, "snowshovel", 32, -1, new ParticleProperty[] { ParticleProperty.DIRECTIONAL }), 
    SLIME("SLIME", 33, "SLIME", 33, "slime", 33, -1, new ParticleProperty[0]), 
    HEART("HEART", 34, "HEART", 34, "heart", 34, -1, new ParticleProperty[0]), 
    BARRIER("BARRIER", 35, "BARRIER", 35, "barrier", 35, 8, new ParticleProperty[0]), 
    ITEM_CRACK("ITEM_CRACK", 36, "ITEM_CRACK", 36, "iconcrack", 36, -1, new ParticleProperty[] { ParticleProperty.DIRECTIONAL, ParticleProperty.REQUIRES_DATA }), 
    BLOCK_CRACK("BLOCK_CRACK", 37, "BLOCK_CRACK", 37, "blockcrack", 37, -1, new ParticleProperty[] { ParticleProperty.REQUIRES_DATA }), 
    BLOCK_DUST("BLOCK_DUST", 38, "BLOCK_DUST", 38, "blockdust", 38, 7, new ParticleProperty[] { ParticleProperty.DIRECTIONAL, ParticleProperty.REQUIRES_DATA }), 
    WATER_DROP("WATER_DROP", 39, "WATER_DROP", 39, "droplet", 39, 8, new ParticleProperty[0]), 
    ITEM_TAKE("ITEM_TAKE", 40, "ITEM_TAKE", 40, "take", 40, 8, new ParticleProperty[0]), 
    MOB_APPEARANCE("MOB_APPEARANCE", 41, "MOB_APPEARANCE", 41, "mobappearance", 41, 8, new ParticleProperty[0]);
    ...
    private ParticleEffect(final String s2, final int n2, final String s, final int n, final String name, final int id, final int requiredVersion, final ParticleProperty... properties) {
        this.name = name;
        this.id = id;
    ...
    {
        REQUIRES_WATER("REQUIRES_WATER", 0, "REQUIRES_WATER", 0), 
        REQUIRES_DATA("REQUIRES_DATA", 1, "REQUIRES_DATA", 1), 
        DIRECTIONAL("DIRECTIONAL", 2, "DIRECTIONAL", 2), 
        COLORABLE("COLORABLE", 3, "COLORABLE", 3);
        
        private ParticleProperty(final String s2, final int n2, final String s, final int n) {
        }
    }
    ...
    public static final class ParticlePacket
    {
        ...
        public ParticlePacket(final ParticleEffect effect, final Vector<?> direction, final float speed, final boolean longDistance, final ParticleData data) throws IllegalArgumentException {
            this(effect, (float)((Block) direction).getX(), (float)((Block) direction).getY(), (float)((Block) direction).getZ(), speed, 0, longDistance, data);
        }
        ...
        private void initializePacket(final Location center) throws PacketInstantiationException {
            ...
            try {
                ...
                if (ParticlePacket.version < 8) {
                    ...
                    if (this.data != null) {
                        name = String.valueOf(String.valueOf(name)) + this.data.getPacketDataString();
                    }
                    ...
                    if (this.data != null) {
                        ...
                        ReflectionUtils.setValue(packet, true, "k", value);
                    }
                }
